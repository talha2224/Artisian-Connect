  ...
  return (
    <div className='bg-black w-screen p-10 md:flex md:justify-between md:flex-wrap'>
      ...
      <div className='mb-6 md:mb-0'>
        ...
        <p className='text-white mb-2 tracking-wider text-xs cursor-pointer'>Get exciting offers daily</p>
      ...
      <div className='mb-6 md:mb-0'>
        ...
        <p className='text-white mb-2 tracking-wider text-sm cursor-pointer'>artisian@gmail.com</p>
